...
<html lang="es">
  ...
  <body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h3 class="text-center">Reporte Ventas por Vendedor</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12">
					<form id="form_reportes" class="form-inline">
						...
						<button  type="submit" class="btn btn-primary hidden-print" id="btn_buscar">
			...
			<hr> 
			<div class="row">
				<div class="col-sm-12 text-center table-responsive" id="lista_registros">
		...
		<script src="ventas_vendedor.js"></script>
