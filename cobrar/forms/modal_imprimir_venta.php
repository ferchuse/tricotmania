						...
						<div class=" row justify-content-start">
							<div class="pad-10 mar-0 col-xs-12">
								<div style="margin: 0px;" class="mar-0 row ">
									...
									<div class="col-xs-7 text-left" id="id_ventas"><?php echo $fila_venta[0]["id_ventas"] ?></div>
								</div>
								<div style="margin: 0px;" class="mar-0 row ">
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<label>
											<INPUT TYPE="radio" class="forma_pago" name="forma_pago" value="efectivo" <?php echo $fila_venta[0]["forma_pago"] == "efectivo" ? "checked": ""?>> Efectivo 
										</label><br> 
										<label><INPUT TYPE="radio" class="forma_pago" name="forma_pago" value="tarjeta" <?php echo $fila_venta[0]["forma_pago"] == "tarjeta" ? "checked": ""?>> 
											Tarjeta
										</label>
									</div>
								</div>
						...
						<thead style="margin-top: 0px; padding:0px;">
							...
							<tfoot>
								...
								<tr>
									...
									<td class=" text-right"><?php echo "$<span id='total'>" . $producto["total_ventas"]."</span>"; ?></td>
								</tr>
