				...
				<div class="row " >
					<div class="table-responsive" id="div_tabla">
						...
						<?php
							...
							<tr>
								<td>
									<input type='text' class="form-control" name='nombre_completo' size='20' value="<?php echo "$nombre_usuario"; ?>" />
								</td>
								<td align="right">
									<input type='text' class="form-control" name="pass" size='20' value="<?php echo "$usuario"; ?>" />
								</td>
								<td align="right">
									<input type='password' class="form-control" name='pass' value="<?php echo "$password"; ?>" />
								</td>
								<td align="right">
									<select id="permisos" class="form-control" name="permisos">
										<option <?php echo is_selected("Administrador", $permisos);?> value="Administrador">Administrador</option>
										<option <?php echo is_selected("Usuario", $permisos);?> value="Usuario">Usuario</option>
									</select>						
								</td>
								
								
								<td align="right">
									<button class="btn btn_update btn-success" data-id_value="<?php echo "$id_usuario";?>" type="button" id="<?php echo "$id_usuario";?>]">
										<i class="fa fa-save"></i> 
									</button>
									<button class="btn btn_delete btn-danger" data-id_value="<?php echo "$id_usuario";?>" type="button" >
