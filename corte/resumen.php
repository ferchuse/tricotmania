					...
					<div class="col-sm-12">
						<div class="panel panel-info hidden-print" id="head_ingresos">
							...
							<div class="panel-footer h4">
								...
								<?php
									$saldo_final = $fila_turno["efectivo_inicial"] + $suma_total + $totales["entradas"] - $totales["salidas"];
								?>
								...
								<div class="row no-gutters">
									...
									<div class="cantidad col-xs-2 text-right"><input type="number" id="efectivo_inicial" class="form-control" value="<?php echo $_COOKIE["efectivo_inicial"] ?>"></div>
								</div>
								<div class="row no-gutters">
		...
		<div id="resumen" class="visible-print">
			...
			<div style="margin-top: 25px;">
				...
				<div class="row no-gutters">
					...
					<div class="col-xs-1 text-right"></div>
					<div class="col-xs-1 text-center">$</div>
					<div class="cantidad col-xs-3 text-right"><?php echo number_format($fila_turno["efectivo_inicial"], 2) ?></div>
				</div>
				<div class="row no-gutters">
